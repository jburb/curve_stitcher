...
1. **Papercuts**
     ...
     - The shorthand labels for inner-to-outer threads used in the thread picker should be updated for better clarity, e.g. "I->O" should become "I->O (Bridged)" and "I->R" should become "I->O (Projected)" or at a minimum "I->O(B)" and "I->O(P)", respectively.
